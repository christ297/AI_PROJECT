...
def get_input_args():
    ...
    parser.add_argument('--arch', default = 'vgg' ,help="this is cnn model by default is vgg ")
    parser.add_argument('--dogfile', default = 'dognames.txt' ,help="this is dognames.txt")
