...
def get_input_args():
    ...
    parser.add_argument('--arch', default = 'vgg' ,help="--arch - the CNN model architecture")
    parser.add_argument('--dogfile', default = 'dognames.txt' ,help="--dogfile - text file of names of dog breeds")
